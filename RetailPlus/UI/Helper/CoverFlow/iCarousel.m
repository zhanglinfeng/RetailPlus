...
- (CATransform3D)transformForItemView:(UIView *)view withOffset:(CGFloat)offset
{
    ...
    switch (type)
    {
        ...
        {
            CGFloat tilt = 0.9f;
            CGFloat spacing = 0.35f; // should be ~ 1/scrollSpeed;
...
{
    iCarousel *carousel = (__bridge iCarousel *)((void *)context);
...
- (void)depthSortViews
{
    ...
    for (UIView *view in [[itemViews allValues] sortedArrayUsingFunction:compareViewDepth context:(void *)self])
    {
