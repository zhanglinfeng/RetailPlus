...
- (id)initWithFrame:(CGRect)frame withValue:(NSMutableArray *)valueArr withColor:(NSMutableArray *)colorArr
{
    ...
    if (self) {
       // [self sortValueArr:valueArr colorArr:colorArr];
        ...
        int amountWidth = 75;
        self.amountLabel = [[UILabel alloc]initWithFrame:CGRectMake((centerImage.size.width/2 - amountWidth)/2, (centerImage.size.height/2 - 22)/2, amountWidth, 22)];
...
- (void)setAmountText:(NSString *)text withColor:(UIColor *)color
{
